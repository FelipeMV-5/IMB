		...
		?>
			...
			<div class="hl-cont">
				<div class="hl-top">
					...
					<div class="circulo">
						<div class="hl-pic"><a href="perfil.php?username=<?php echo $rowB['username'];?>"><img src="images/avatar.png<?php echo $rowB['avatar']; ?>" width="35" height="35" ></a></div>
				...
				<div class="hl-section-likes">
					...
					<!-- Icono de comentario con enlace a la sección de comentarios -->
					<a href="comentarios.php?post_id=<?php echo $rowA['id']; ?>">
						<img src="images/icons/comentario.png" style="cursor: pointer;">
					</a>

					<?php if($cLikes2 == 0) { ?>
						<div id="FAV<?php echo $rowA['id']; ?>" class="fav" style="float: left;">
							<img src="images/icons/favorito.png">
						</div>
					<?php } else { ?>
						<div id="FAV<?php echo $rowA['id']; ?>" class="fav" style="float: left;">
							<img src="images/icons/favorito2.png">
						</div>
					<?php } ?>
				</div>	
